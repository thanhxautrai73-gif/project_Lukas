                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-sm-8 col-lg-2">
                        <div className="site-action d-flex justify-content-center justify-content-sm-end align-items-center">
                            <div className="user-setting-wrap" style={{ marginRight: '20px', display: 'flex', alignItems: 'center' }}>
                                <button 
                                ...
                                >
                                    <i className="ion-android-person" style={{ fontSize: '24px' }} />
                                </button>
                                <ul className={`user-dropdown-menu ${isUserMenuOpen ? 'open' : ''}`}>
                                    {user ? (
                                        <>
                                            <li className="user-info-header" style={{ padding: '5px 0', borderBottom: '1px solid #f4f3ec', marginBottom: '8px' }}>
                                                <div style={{ fontWeight: 'bold', fontSize: '14px', color: '#1b1b1c' }}>{user.username}</div>
                                                <div style={{ fontSize: '11px', color: '#888', wordBreak: 'break-all' }}>{user.role === 'admin' ? 'Quản trị viên' : 'Khách hàng'}</div>
                                            </li>
                                            {user.role === 'admin' && (
                                                <li>{renderLink("/admin/dashboard", "Quản Trị Hệ Thống")}</li>
                                            )}
                                            <li>
                                                <button 
                            ...
                            <div className="responsive-menu d-lg-none">
                                <button className="btn-menu"><i className="fa fa-bars" /></button>
                            </div>
                        </div>
                    </div>
                </div>
