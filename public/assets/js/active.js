...
(function($) {
    ...
    function initActiveJs() {
        ...
        --------------------------------*/
        // Destroy existing slicknav if any
        $('.res-mobile-menu').empty();
        ...
        $(".off-canvas-overlay, .btn-close").off('click').on('click', function() {
        ...
        galleryBtnPopup.off('click').on('click', function(event) {
        ...
        $(".btn-scroll-top").off('click').on('click', function() {
            $('html, body').animate({
                scrollTop: 0
            }, 1500);
        });
        ...
        layoutSelector.off('click').on('click', function() {
        ...
        -----------------------------------*/
        var proQty = $(".pro-qty");
        if (proQty.find('.qty-btn').length === 0) {
            proQty.append('<a href="#" class="inc qty-btn">+</a>');
            proQty.append('<a href="#" class= "dec qty-btn">-</a>');
        }
        $('.qty-btn').off('click').on('click', function(e) {
            e.preventDefault();
            var $button = $(this);
        ...
        /*--------------------------------------
          10. Checkout Page Checkbox Accordion
        ----------------------------------------*/
        $("#create_pwd").off("change").on("change", function() {
            $(".account-create").slideToggle("100");
        });

        $("#ship_to_different").off("change").on("change", function() {
        ...
        // Hero Slider Js
        if ($(".slider-content-active").hasClass('slick-initialized')) {
            $(".slider-content-active").slick('unslick');
        }
        ...
        if ($(".brand-logo-content").hasClass('slick-initialized')) {
            $(".brand-logo-content").slick('unslick');
        }
        ...
        // Product Details Thumbnail
        if ($(".product-details-thumbnail-nav").hasClass('slick-initialized')) {
            $(".product-details-thumbnail-nav").slick('unslick');
        }
    ...
    // Expose to window
    window.initActiveJs = initActiveJs;
